...
FIXED_PROVIDER_PATH = "cian.middlewares.fake_useragent.providers.FixedUserAgentProvider"
FAKE_USERAGENT_PROVIDER_PATH = (
    ...
    def process_request(self, request, spider):
        if self._per_proxy:
            ...
            if proxy not in self._proxy2ua:
                ...
                logger.debug(
                    "Assign User-Agent %s to Proxy %s" % (self._proxy2ua[proxy], proxy)
                )
